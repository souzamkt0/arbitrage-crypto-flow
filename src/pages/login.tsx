...
const Login = () => {
  ...
  // Google OAuth removido conforme solicitado
  ...
  return (
    <div className="min-h-screen relative overflow-hidden bg-black">
      ...
      <div className="absolute inset-0">
        ...
        {/* Dynamic lines */}
        <div className="absolute inset-0">
          <div className="absolute top-1/3 left-0 w-full h-0.5 bg-gradient-to-r from-transparent via-yellow-400 to-transparent opacity-20 animate-pulse"></div>
          <div className="absolute bottom-1/3 left-0 w-full h-0.5 bg-gradient-to-r from-transparent via-yellow-400 to-transparent opacity-20 animate-pulse animation-delay-800"></div>
          <div className="absolute left-1/4 top-0 w-0.5 h-full bg-gradient-to-b from-transparent via-yellow-400 to-transparent opacity-10 animate-pulse animation-delay-400"></div>
          <div className="absolute right-1/4 top-0 w-0.5 h-full bg-gradient-to-b from-transparent via-yellow-400 to-transparent opacity-10 animate-pulse animation-delay-1200"></div>
        </div>
      ...
      <div className="relative z-10 min-h-screen flex items-center justify-center p-4">
        <div className="w-full max-w-lg">
          ...
          <div className="mb-6 animate-fade-in-up">
            <Link to="/register" className="inline-flex items-center text-gray-400 hover:text-yellow-400 transition-colors duration-200">
          ...
          <div className="text-center mb-8 animate-fade-in-up">
            <div className="flex justify-center mb-6">
              <div className="relative">
                {/* Logo Container */}
                <div className="w-24 h-24 bg-gradient-to-br from-gray-800 to-gray-700 rounded-2xl flex items-center justify-center border-2 border-yellow-400/30 shadow-2xl transform hover:scale-105 transition-transform duration-300">
                  {/* Diamond Pattern */}
                  <div className="relative">
                    {/* Main diamond shape */}
          ...
          {/* Login Card */}
          <Card className="bg-gray-900/90 backdrop-blur-xl border-yellow-400/30 shadow-2xl animate-fade-in-up animation-delay-400 rounded-3xl overflow-hidden">
            ...
            <CardContent>
              <form onSubmit={handleLogin} className="space-y-6">
                ...
                <div className="space-y-2 animate-fade-in-up animation-delay-600">
                  <div className="relative group">
                    <Mail className="absolute left-4 top-1/2 transform -translate-y-1/2 h-5 w-5 text-gray-400 group-focus-within:text-yellow-400 transition-colors duration-200" />
                    <Input
                      id="email"
                      name="email"
                      type="email"
                      ...
                      className="pl-12 pr-4 py-3 bg-transparent border-0 border-b-2 border-gray-600 text-white placeholder-gray-400 focus:border-yellow-400 focus:ring-0 transition-all duration-200 rounded-none"
                      required
                    />
                  </div>
                </div>
                ...
                <div className="space-y-2 animate-fade-in-up animation-delay-700">
                  <div className="relative group">
                    <Lock className="absolute left-4 top-1/2 transform -translate-y-1/2 h-5 w-5 text-gray-400 group-focus-within:text-yellow-400 transition-colors duration-200" />
                    <Input
                      id="password"
                      name="password"
                      type="password"
                ...
                <div className="animate-fade-in-up animation-delay-800">
                  <Button 
                    type="submit" 
                    className="w-full bg-yellow-400 hover:bg-yellow-500 text-black font-semibold py-3 rounded-xl transform hover:scale-[1.02] transition-all duration-200 shadow-lg" 
                    disabled={isLoading}
                  >
              ...
              {/* Register Link */}
              <div className="mt-8 pt-6 border-t border-gray-700 animate-fade-in-up animation-delay-900">
