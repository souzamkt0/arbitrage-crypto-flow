        ...
        <div className="w-full max-w-md">
          ...
          <Card className="bg-gradient-to-b from-gray-900/80 to-black/80 backdrop-blur-xl border-white/10 shadow-2xl animate-fade-in-up animation-delay-400 rounded-3xl overflow-hidden">
            ...
            <CardContent>
              ...
              {/* Divider */}
              <div className="relative my-6 animate-fade-in-up animation-delay-1050">
              ...
              <Button
                ...
                disabled={isLoading}
                className="w-full bg-white hover:bg-gray-100 text-gray-900 font-semibold py-4 rounded-2xl transform hover:scale-[1.02] transition-all duration-200 shadow-lg hover:shadow-white/25 animate-fade-in-up animation-delay-1050 text-lg disabled:opacity-50 disabled:cursor-not-allowed flex items-center justify-center space-x-3"
              >
