                        ...
                        {canInvest && (
                          <div className="mb-4 bg-gradient-to-r from-blue-50 to-cyan-50 dark:from-blue-900/20 dark:to-cyan-900/20 rounded-lg p-4 border border-blue-200 dark:border-blue-800">
                            <div className="flex items-center justify-between mb-3">
                              ...
                              <div className="text-right">
                                <div className="text-xs text-blue-600 dark:text-blue-300">Spread médio</div>
                            ...
                            <div className="bg-white dark:bg-gray-800 rounded-lg p-3 border border-blue-100 dark:border-blue-800 mb-3">
                              <div className="flex items-center justify-between mb-2">
                                <div className="flex items-center space-x-2">
                                  <div className="w-2 h-2 bg-green-400 rounded-full animate-ping"></div>
                                  <span className="text-xs font-medium text-gray-700 dark:text-gray-300">Live Opportunities</span>
                                </div>
                                <span className="text-xs text-green-600 font-semibold animate-pulse">
                                  {Math.floor(Math.random() * 8 + 3)} active
                                </span>
                              </div>
                              ...
                              <div className="h-20 flex items-end justify-between space-x-1 mb-2">
                                {Array.from({ length: 12 }, (_, i) => (
                                  <div
                                    key={i}
                                    className="flex-1 bg-gradient-to-t from-blue-400 to-green-400 rounded-sm animate-pulse"
                                    style={{
                              ...
                              <div className="space-y-1">
                                <div className="flex justify-between items-center p-1 bg-gray-50 dark:bg-gray-700 rounded text-xs animate-fade-in">
                                  <div className="flex items-center space-x-1">
                                    <div className="w-1 h-1 bg-green-500 rounded-full animate-pulse"></div>
                                    <span className="font-medium">BTC/USDT</span>
                                    <span className="text-gray-500">Binance → Coinbase</span>
                                  </div>
                                  <div className="font-semibold text-green-600 animate-pulse">
                                    +{(Math.random() * 1.8 + 1.2).toFixed(2)}%
                                  </div>
                                </div>
                                <div className="flex justify-between items-center p-1 bg-gray-50 dark:bg-gray-700 rounded text-xs animate-fade-in" style={{ animationDelay: '0.5s' }}>
                                  <div className="flex items-center space-x-1">
                                    <div className="w-1 h-1 bg-yellow-500 rounded-full animate-pulse"></div>
                                    <span className="font-medium">ETH/USDT</span>
                                    <span className="text-gray-500">Kraken → OKX</span>
                                  </div>
                                  <div className="font-semibold text-green-600 animate-pulse">
                                    +{(Math.random() * 1.5 + 0.8).toFixed(2)}%
                                  </div>
                                </div>
                                <div className="flex justify-between items-center p-1 bg-gray-50 dark:bg-gray-700 rounded text-xs animate-fade-in" style={{ animationDelay: '1s' }}>
                                  <div className="flex items-center space-x-1">
                                    <div className="w-1 h-1 bg-blue-500 rounded-full animate-pulse"></div>
                                    <span className="font-medium">ADA/USDT</span>
                                    <span className="text-gray-500">Bybit → Huobi</span>
                                  </div>
                                  <div className="font-semibold text-green-600 animate-pulse">
                                    +{(Math.random() * 2.1 + 1.0).toFixed(2)}%
                                  </div>
                                </div>
                              </div>
                            </div>
                            ...
                            <div className="flex items-center justify-between text-xs">
                              <span className="text-blue-600 dark:text-blue-300 animate-pulse">
                                🔄 Atualizado: {new Date().toLocaleTimeString()}
                              </span>
                              <span className="text-green-600 font-medium animate-pulse">
                                Próxima: {Math.floor(Math.random() * 15 + 5)}s
                              </span>
                            </div>
                          </div>
                        )}
