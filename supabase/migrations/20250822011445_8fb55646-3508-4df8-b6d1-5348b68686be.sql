-- Corrigir a função process_investment para usar UUID correto
...
BEGIN
    ...
    -- Definir dados dos planos baseados no ID e gerar UUID
    CASE p_plan_id
        WHEN 'robo-400' THEN
    ...
    -- Criar investimento usando UUID
